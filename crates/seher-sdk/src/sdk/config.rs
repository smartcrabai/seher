...
pub struct ProviderEntry {
    ...
    pub provider: String,
    /// Underlying SDK kind (e.g. `"pi"`, `"omp"`, `"pi-rust"`,
    /// `"claude-terminal"`, `"claude-headless"`). Defaults to `"pi"` (the
    /// TypeScript Pi RPC subprocess) when omitted in YAML; kept as a string
