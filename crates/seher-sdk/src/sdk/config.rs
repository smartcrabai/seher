...
pub struct ProviderEntry {
    ...
    pub provider: String,
    /// Underlying SDK kind (e.g. `"pi"`, `"pi-rust"`, `"claude-terminal"`,
    /// `"claude-headless"`). Defaults to `"pi"` (the TypeScript Pi RPC
    /// subprocess) when omitted in YAML; kept as a string for forward
    /// compatibility.
    pub sdk: String,
